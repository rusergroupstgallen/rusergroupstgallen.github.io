...
The are various objects such as vectors, matrices, lists and data frames. 
...
a Tibble is a two dimensional frame which is made of of diferent colums whereby each column is a distinct vector. 
