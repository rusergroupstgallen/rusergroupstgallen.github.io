...
gapminder %>% 
    ...
    pivot_wider(names_from = year,
                values_from = values)
```
\textit{Note:} The `1e3` and `1e6` are scientific notation for 1'000 and 1'000'000. By using this, you can avoid mistakes coming from typing too many or too few zeros.
\newpage
